...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <form action="/upload_contract.php" method="post" enctype="multipart/form-data" class="mb-4">
                <input type="file" name="contractFile" id="contractFile" class="form-control">
                <button type="submit" class="btn btn-primary mt-2">Subir Nuevo Contrato</button>
            </form>
        </div>
    </div>
