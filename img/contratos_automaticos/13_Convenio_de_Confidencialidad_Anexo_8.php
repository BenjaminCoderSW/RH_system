...
<body>
    ...
    <div class="content">
        ...
        <div class="sub-titulo3" ><strong><u>A N E X O  A</u></strong></div>
            <p>ESTE ANEXO FORMA PARTE INTEGRANTE DEL CONVENIO DE CONFIDENCIALIDAD CELEBRADO ENTRE CONSTRUCTORA ATZCO SA DE CV, REPRESENTADA EN ESTE ACTO POR ISRAEL RODRÍGUEZ ESCAMILLA, EN LO SUCESIVO DENOMINADA LA EMPRESA, Y <strong><?php echo $apellidoPaterno . " " .$apellidoMaterno . " " . $nombres; ?></strong> DE FECHA <?php echo $diaDeIngreso . " de " .$mesDeIngreso . " de " . $anioDeIngreso; ?> <br><br>
