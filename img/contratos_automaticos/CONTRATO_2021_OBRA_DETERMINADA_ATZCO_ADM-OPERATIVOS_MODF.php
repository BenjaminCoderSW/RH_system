...
<body>
    ...
    <div class="content">
        <p>CONTRATO INDIVIDUAL DE TRABAJO POR OBRA DETERMINADA QUE CELEBRAN, POR UNA PARTE <strong><?php echo $nombreEmpresa; ?></strong>, A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ “LA EMPRESA” Y POR LA OTRA, POR SU PROPIO DERECHO, <strong><?php echo $nombreCompleto; ?></strong> A QUIEN SE LE DENOMINARÁ “EL TRABAJADOR (A)”, DE CONFORMIDAD CON LAS SIGUIENTES DECLARACIONES Y SUBSECUENTES CLÁUSULAS.</p>
            ...
            <tr>
                ...
                <td>
                    <div class="signature-block">
                        ...
                        <p>_____</p>
                        <strong>
                            <p class="signature-name"><?php echo $testigo; ?></p><strong>
                    </div>
                </td>
            </tr>
        </table>
...
<p>AVISO DE PRIVACIDAD relacionado con los datos personales de los Prospectos y/o Colaboradores, (en adelante el “Titular”), recabados por CONSTRUCTORA ATZCO, S.A. DE C.V., sus filiales y subsidiarias (en adelante denominada como “ATZCO”)</p>
<div class="content-terms">
    ...
    <p>Fecha última de actualización: 22 de junio del 2022</p>
        ...
        <div class="content">
            ...
            <div class="">
                <h5>Firma del aspirante: ____ Huella: __ Ciudad y Fecha</h5> 
            </div>
        </div>
    </div>
    <br><br><br>
