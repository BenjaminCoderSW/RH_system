...
<br>
    ...
    <p><strong><?php echo $nombreCompleto; ?></strong></p>
        ...
        <p>CONVENIO DE CONFIDENCIALIDAD QUE CELEBRAN POR UNA PARTE LA SOCIEDAD DENOMINADA CONSTRUCTORA ATZCO SA DE CV, REPRESENTADA EN ESTE ACTO POR ISRAEL RODRÍGUEZ ESCAMILLA A QUIÉN EN LO SUCESIVO Y PARA EFECTOS DEL PRESENTE CONVENIO SE DENOMINARÁ “LA EMPRESA”, Y POR LA OTRA <?php echo $nombreCompleto; ?> Y A QUIÉN EN LO SUCESIVO Y PARA EFECTOS DEL PRESENTE CONVENIO SE DENOMINARÁ “EL CONFIDENTE”, AL TENOR DE LAS SIGUIENTES DECLARACIONES Y CLÁUSULAS.</p>
...
<div class="content-terms">
    ...
    <p><strong>3.2.-</strong> El domicilio que para los efectos del presente Aviso establece ATZCO es el ubicado en Boulevard Paseo de los Insurgentes No.902 Int. 7 Col. Jardines del Moral León Guanajuato. y/o su portal de internet es www.atzco.com.mx.</p>
    <p><strong>4.- Datos que se recaban y su origen</strong></p>
    <p><strong>4.1.-</strong> EL TITULAR acepta y reconoce que ATZCO obtendrá directamente, a través de recomendaciones de otros colaboradores, a través de Bolsas de Trabajo o publicaciones en redes sociales los datos personales sensibles y no sensibles de EL TITULAR, mismos que corresponden a los siguientes:</p>
