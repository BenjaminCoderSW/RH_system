...
$nombreCompleto = $datosEmpleado['empleado_apellido_paterno'] . ' ' . $datosEmpleado['empleado_apellido_materno'] . ' ' . $datosEmpleado['empleado_nombres'];
...
<head>
    ...
    <style>
        ...
        .indent-paragraph {
            margin-left: 2em; /* Ajusta este valor según el espacio deseado */
            margin-bottom: 1em;
        }
        .sub-paragraph {
            text-indent: -1.5em; /* Ajusta este valor según el espacio deseado */
            margin-left: 3.5em; /* Ajusta este valor según el espacio deseado */
        }
        .content-table {
            width: 100%;
            border-collapse: collapse;
        ...
        .right-column {
            width: 40%;
            text-align: left;
            padding-left: 50%; /* Ajustar el valor para centrar el símbolo de $ */
        }
        .derecha{
            text-align: right;
        }
...
<body>
    ...
    <div class="content">
        ...
        <p>a) Ser una sociedad mercantil debidamente constituida conforme a las leyes mexicanas, y estar 
        ...
        <p>b) Tener su domicilio en Cerrada. Boulevard paseo de los insurgentes #902 int. 7 Colonia Jardines del Moral, León Gto.
        </p>
        <h4>II.- DECLARA “EL TRABAJADOR (A)”:</h4>
<p>a) Llamarse como ha quedado escrito en el encabezado de este contrato.<br>
b) Ser de nacionalidad MEXICANA. <strong>PRIMERA.-</strong> "EL TRABAJADOR (A)" se obliga a prestar a "LA EMPRESA" sus servicios por OBRA DETERMINADA a partir del día <?php echo $datosEmpleado['empleado_dia_de_ingreso'] . " " . $datosEmpleado['empleado_mes_de_ingreso'] . " " . $datosEmpleado['empleado_año_de_ingreso']; ?> y hasta el día que finalice el contrato <?php echo $datosEmpleado['empleado_numero_de_contrato']; ?> para desempeñar el cargo de: <?php echo $datosEmpleado['empleado_puesto_de_trabajo']; ?> que ejecutará en el domicilio ubicado en <?php echo $datosEmpleado['empleado_lugar_de_servicio_o_de_proyecto']; ?>, la cual una vez concluido el periodo de tiempo establecido en el presente contrato terminará la vigencia del mismo. "EL TRABAJADOR (A)" prestará dichos servicios de forma subordinada bajo la dirección de los funcionarios designados al efecto, aceptando ejecutar al mismo tiempo aquellas labores similares y conexas, así como las que se deriven de los usos y prácticas, además de las señaladas en las disposiciones relativas en los procedimientos de trabajo, y administración del personal que "LA EMPRESA" tiene establecidos en relación a las actividades contratadas.<br>
c) Ser de sexo <?php echo $sexo; ?>.<br>
d) Ser su estado civil <?php echo $estadoCivil; ?>.<br>
e) Mayor de edad.<br>
f) Tener su domicilio en <?php echo $domicilio; ?>, y que es que señala para recibir notificaciones por parte de “LA EMPRESA”.<br>
g) Que su número de CURP es <?php echo $curp; ?>, y su número de afiliación ante el Instituto Mexicano del Seguro Social es <?php echo $nss; ?>.<br>
h) Que no tiene enfermedad ni incapacidad física o mental alguna que imposibilite para desempeñar el trabajo para el que se le contrata.<br>
i) Que cuenta con la capacidad, conocimientos y experiencia necesarios para prestar sus servicios personales en los términos del presente contrato.<br>
En virtud de lo anterior, ambas PARTES convienen en obligarse de acuerdo con las siguientes:</p>
<br><br><br><br><br><br><br><br><br><br>
        ...
        <p>a) Realizar, de manera temporal, la reducción del número de horas de la jornada de trabajo asignada a "EL TRABAJADOR ( A )", así como el ajuste correspondiente al salario a éste asignado dependiendo de las horas a laborar por el mismo, de acuerdo con las necesidades de "LA EMPRESA", considerando las exigencias del mercado de la industria al que "LA EMPRESA" provee de servicios y productos. No obstante estas reducciones de carácter temporal, sea su duración cual fuere, no sentarán precedente ni obligación para "LA EMPRESA", y una vez que resuelta sea la problemática que orillo a "LA EMPRESA" a la reducción de la jornada de trabajo y ajuste realizado al salario de "EL TRABAJADOR ( A )", "LA EMPRESA" restablecerá tanto la jornada de trabajo como el salario asignado a "EL TRABAJADOR ( A )" en las mismas condiciones previas a la reducción temporal referida<br>
        b) "EL TRABAJADOR ( A )" está obligado a checar su tarjeta, plasmar su huella digital o firmar las listas de asistencia, a la entrada o la salida de sus labores, por lo que el incumplimiento de este requisito indicará la falta injustificada a sus labores, para todos los efectos legales.</p>
<br>
       ...
       <p></p><strong>VIGESIMA.-</strong> "LA EMPRESA" podrá rescindir la presente relación laboral, sin responsabilidad para el mismo, en los siguientes casos:
        <br><span class="sub-paragraph"><strong>l.</strong> En caso de incompetencia evidente por parte de "EL TRABAJADOR (A)" en el desempeño de las funciones y actividades para las que se le contrata de conformidad con el presente contrato, así como por falta de probidad u honradez en el desarrollo de sus labores;</span>
        <br><span class="sub-paragraph"><strong>ll.</strong> Si "EL TRABAJADOR (A)" no cumple con las instrucciones, funciones y obligaciones determinadas por "LA EMPRESA" y sus representantes, y con las establecidas en el REGLAMENTO INTERIOR DE TRABAJO de ésta;</span>
        <br><span class="sub-paragraph"><strong>lll.</strong> Si "EL TRABAJADOR (A)" incurre en faltas graves a los principios y políticas empresariales de "LA EMPRESA", establecidas en el presente Contrato;</span>
        <br><span class="sub-paragraph"><strong>lV.</strong> Por la comisión, por parte de "EL TRABAJADOR (A)", de cualesquiera de los supuestos establecidos en el Artículo 47 de la Ley Federal del Trabajo.</span>
    </p>
        ...
        <br><span class="sub-paragraph"><strong>l.</strong> El mutuo consentimiento de las partes;</span>
        <br><span class="sub-paragraph"><strong>ll.</strong> La muerte de "EL TRABAJADOR (A)";</span>
        <br><span class="sub-paragraph"><strong>lll.</strong> La incapacidad física o mental o inhabilidad manifiesta de "EL TRABAJADOR (A)" que haga imposible la prestación del trabajo, y</span>
        <br><span class="sub-paragraph"><strong>lV.</strong> Los casos a que se refiere el Artículo 434 de la Ley Federal del Trabajo.</span>
    </p>
    <br><br><br><br>
            ...
            <tr>
                <td>
                    <div class="signature-block">
                        ...
                        <p><strong>ING. JOSE DOLORES CU GUERRERO</strong></p>
                        ...
                        <p>________________________</p>
                        <strong>
                            <p>LIC. BARRIENTOS RUIZ ELIZABETH</p>
                        </strong>
                    </div>
                </td>
                <td>
                    <div class="signature-block">
                        ...
                        <p>________________________</p>
                        <strong>
                            <p>LIC. SANCHEZ SERRANO ANA DANIELA</p>
                        </strong>
                    </div>
                </td>
            </tr>
    ...
    <div class="content">
        ...
        <p><strong><?php echo $nombreCompleto; ?></strong></p>
<br>
       <h3 class="titulo-centrado"><u>RECIBO DE FINIQUITO</u></h3>
    ...
    <table class="content-table">
        <tr>
            <td class="left-column"><strong>1.</strong> Salarios Devengados:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>2.</strong> Aguinaldo:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>3.</strong> Vacaciones:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>4.</strong> Prima Vacacional:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>5.</strong> Horas Extras:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>6.</strong> Séptimos Días:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>7.</strong> Días de Descanso Obligatorios:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>8.</strong> Prima de Antigüedad:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>9.</strong> Gratificación:</td>
            <td class="right-column">$</td>
        </tr>
    </table>
    <p><strong>TOTAL QUE SE PAGA: <span style="padding-left: 36%;">$</span></strong></p>
    <p><strong>DEDUCCIONES</strong></p>
    <table class="content-table">
        <tr>
            <td class="left-column"><strong>1.</strong> PRÉSTAMOS:</td>
            <td class="right-column">$</td>
        </tr>
        <tr>
            <td class="left-column"><strong>2.</strong> ADEUDOS:</td>
            <td class="right-column">$</td>
        </tr>
    </table>
    <p><strong>TOTAL DEDUCCIONES: <span style="padding-left: 35%;">$</span></strong></p>
    <p><strong>TOTAL A RECIBIR: <span style="padding-left: 40%;">$</span></strong></p>
    ...
    <p><strong><?php echo $nombreCompleto; ?></strong></p>
        ...
        <p>CONVENIO DE CONFIDENCIALIDAD QUE CELEBRAN POR UNA PARTE LA SOCIEDAD DENOMINADA <?php echo $nombreEmpresa; ?>, REPRESENTADA EN ESTE ACTO POR ISRAEL RODRÍGUEZ ESCAMILLA A QUIÉN EN LO SUCESIVO Y PARA EFECTOS DEL PRESENTE CONVENIO SE DENOMINARÁ “LA EMPRESA”, Y POR LA OTRA <?php echo $nombreCompleto; ?> Y A QUIÉN EN LO SUCESIVO Y PARA EFECTOS DEL PRESENTE CONVENIO SE DENOMINARÁ “EL CONFIDENTE”, AL TENOR DE LAS SIGUIENTES DECLARACIONES Y CLÁUSULAS.</p>
...
<br>
        ...
        <p><strong>SEGUNDA.-</strong> EL CONFIDENTE se obliga a guardar en pleno secreto y confidencia la totalidad de la documentación e información a la que tiene acceso como consecuencia directa o indirecta de su relación laboral con LA EMPRESA y con los clientes de la misma, la cual se encuentra descrita en forma enunciativa, más no limitativa, en el <u><strong>Anexo A</strong></u> del presente Convenio (la “Información Confidencial”).
            ...
            <tr>
                <td>
                    <div class="signature-block">
                        ...
                        <strong>
                            <p>ING. ESCAMILLA RODRIGUEZ ISRAEL</p>
                        </strong>
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="signature-block">
                        ...
                        <p>________________________</p>
                        <strong>
                            <p class="signature-name">LIC. BARRIENTOS RUIZ ELIZABETH</p>
                        </strong>
                    </div>
                </td>
                <td>
                    <div class="signature-block">
                        ...
                        <p>________________________</p>
                        <strong>
                            <p class="signature-name">LIC. SANCHEZ SERRANO ANA DANIELA</p><strong>
                    </div>
                </td>
            </tr>
        </table>
                ...
                <tr>
                    <td>
                        <div class="signature-block">
                            ...
                            <p><strong>ING. ESCAMILLA RODRIGUEZ ISRAEL</strong></p>
                ...
                <tr>
                    <td>
                        <div class="signature-block">
                            <p>TESTIGO</p>
                            <p>________________________</p>
                            <p><strong>LIC. BARRIENTOS RUIZ ELIZABETH</strong></p>
                        </div>
                    </td>
                    <td>
                        <div class="signature-block">
                            <p>TESTIGO</p>
                            <p>________________________</p>
                            <p><strong>LIC. SANCHEZ SERRANO ANA DANIELA</strong></p>
                        </div>
                    </td>
                </tr>
            </table>
...
<p class="terminos"><?php echo $nombreCompleto;?>, <span style="font-weight: normal; font-size: 13px;">(el "Titular") con domicilio en</span> <?php echo $domicilio; ?></p>
...
<div class="content-terms">
    ...
    <p><strong>3.1.-</strong> La responsable del tratamiento de los datos personales es <?php echo $nombreEmpresa; ?>, persona moral constituida de conformidad con las leyes de la República Mexicana, (en adelante denominada como GRUPO ATZCO), quien se compromete a respetar lo establecido en el presente Aviso de Privacidad (en lo sucesivo el “Aviso” o el “Aviso de Privacidad” indistintamente), mismo que está puesto a su disposición en cumplimiento de lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (en lo sucesivo la “Ley” o “LFPDPPP” indistintamente) y es aplicable respecto de los datos personales de EL TITULAR.</p>
    <p><strong>3.2.-</strong> El domicilio que para los efectos del presente Aviso establece GRUPO ATZCO es el ubicado en Boulevard Paseo de los Insurgentes No.902 Int. 7 Col. Jardines del Moral León Guanajuato. y/o su portal de internet es www.atzco.com.mx.</p>
    <p><strong>4.- Datos que se recaban y su origen</strong></p>
    <p><strong>4.1.-</strong> EL TITULAR acepta y reconoce que GRUPO ATZCO obtendrá directamente, a través de recomendaciones de otros colaboradores, a través de Bolsas de Trabajo o publicaciones en redes sociales los datos personales sensibles y no sensibles de EL TITULAR, mismos que corresponden a los siguientes:</p>
    ...
    <p><strong>4.2.-</strong> EL TITULAR en este acto, otorga su consentimiento expreso en términos del artículo 9 de la ley de la materia, para que GRUPO ATZCO, trate sus datos personales, incluidos los denominados sensibles, contenidos en ésta cláusula, para cumplir con las finalidades que establece el presente Aviso de Privacidad y en cumplimiento de la legislación vigente se recabará el consentimiento expreso, por escrito y con la firma autógrafa del TITULAR a través del presente.</p>
    <p><strong>4.3.-</strong> GRUPO ATZCO manifiesta que única y exclusivamente accederá y, tratará los datos personales de EL TITULAR, a efecto de llevar a cabo la selección, contratación y administración de personal, debiendo realizar el tratamiento de los datos personales de conformidad con el presente aviso de privacidad.</p>
    <p><strong>4.4.-</strong> EL TITULAR en este acto, bajo protesta de decir verdad, acepta que los datos que ha proporcionado a GRUPO ATZCO son veraces, actuales y correctos. Además, se compromete a sacar en paz y a salvo a GRUPO ATZCO de cualquier demanda o reclamación, derivada de los errores en los datos que le haya entregado.</p>
    <p><strong>4.5.-</strong> GRUPO ATZCO manifiesta que podrá obtener los datos personales de EL TITULAR mediante las denominadas fuentes de acceso público, a efecto de validar y actualizar los datos de EL TITULAR, respetando en todo momento la expectativa razonable de privacidad, a que se refiere el artículo 7 de la LFPDPPP.</p>
    <p><strong>5.- Finalidades del tratamiento de los datos personales</strong><br> <strong>5.1.-</strong> GRUPO ATZCO acepta y reconoce que podrá tratar los datos personales de EL TITULAR, directamente y/o a través de encargados, de conformidad al tipo de relación que tiene con EL TITULAR, para las siguientes finalidades primarias: <br>
    <strong>a)</strong> Contactarlo para efectuar los trámites que en su momento se estén llevando a cabo.<br>
    <strong>b)</strong> Validar la información personal presentada por el titular de los datos.<br>
    <strong>c)</strong> Contactar a sus familiares para el caso de emergencia.<br>
    <strong>d)</strong> Hacer intercambios de bolsas de trabajo con terceros y hacer recomendaciones personales de EL TITULAR o dar referencias al respecto del mismo.<br>
    <strong>e)</strong> Conocer las competencias lingüísticas, experiencia laboral y el estado de salud de EL TITULAR a efecto de identificar algún antecedente patológico, hereditario y traumatológico que pueda influir en su desempeño y desarrollo en la empresa y, conocer la viabilidad de que realice otras funciones.<br>
    <strong>f)</strong> Realizar un expediente de EL TITULAR que será resguardado en las oficinas de Recursos Humanos ya sea en medios físicos, magnéticos o electrónicos. Para el caso de los prospectos/candidatos que no hayan sido seleccionados por GRUPO ATZCO para una determinada posición, sus datos serán conservados por el plazo de 1-un año desde el momento de su recolección. Para aquellos prospectos/candidatos que hayan sido seleccionados para desempeñar una determinada posición, sus datos serán conservados por toda la vigencia de la relación laboral que los une con GRUPO ATZCO y hasta 5 años luego de finalizada dicha relación laboral.<br>
    <strong>g)</strong> En su caso, para realizar los trámites de selección y administración de personal, tales como alta ante el Instituto Mexicano del Seguro Social y demás instituciones que se requiera.<br>
    <strong>h)</strong> Dar cumplimiento a lo establecido en las reformas fiscales vigentes y/o que estén por entrar en vigor.<br>
    <strong>5.2.-</strong> Las partes acuerdan que GRUPO ATZCO se obliga a observar respecto de los datos personales que recaba de EL TITULAR, los principios de licitud, consentimiento, información, calidad, finalidad, lealtad, proporcionalidad y responsabilidad.<br>
    <strong>6.- Limitaciones para el acceso y divulgación de los datos personales</strong><br> <strong>6.1.-</strong> GRUPO ATZCO, se compromete a realizar su mejor esfuerzo para proteger la seguridad de los datos personales que EL TITULAR le está entregando, adoptando, estableciendo y manteniendo, en la medida de sus capacidades, medidas de seguridad administrativas, legales, técnicas y físicas que permitan proteger los datos personales contra daño, pérdida, alteración, destrucción o el uso, acceso o tratamiento no autorizado. (i) utiliza redes privadas, (ii) mantenimientos programados al site donde se guarda la información (iii) se utilizan equipos firewall, (iv) equipos no-breaks, (v) restricciones de Internet en equipos de cómputo (vi) bloqueos a través de antivirus, de salidas USB y de quemadores de discos compactos, en todos los equipos de su personal y colaboradores (vii) mantiene actualizados los equipos de respaldo, (viii) cuentas de acceso personalizado al sistema a través de usuarios y contraseñas; (ix) garantiza la confidencialidad de la información y de los datos personales que trata, a través de la celebración de contratos de confidencialidad con todos los proveedores, prestadores de servicios y colaboradores.<br> <strong>6.2.-</strong> En este tenor, ATZCO se obliga a tomar las medidas necesarias para garantizar que los encargados que utilice cumplan con lo establecido en el presente Aviso de Privacidad, con las obligaciones a su cargo.<br> <strong>6.3.-</strong> No obstante lo anterior y, en caso de que se presenten vulneraciones de seguridad ocurridas en cualquier fase del tratamiento, que afecten de forma significativa los derechos patrimoniales o morales de LOS TITULARES, esto será informado por correo electrónico, de forma inmediata, por ATZCO, a fin de que estos últimos puedan tomar las medidas correspondientes a la defensa de sus derechos, deslindando de cualquier responsabilidad a ATZCO si la vulneración no es imputable a él.<br>
    <strong>7.- Designado para tramitar las solicitudes</strong><br> <strong>7.1.-</strong> En caso de que EL TITULAR necesite revocar su consentimiento, así como acceder, rectificar, cancelar u oponerse al tratamiento de los datos personales que ha proporcionado, lo deberá hacer a través de la persona designada por GRUPO ATZCO cuyos datos se describen a continuación:<br> Correo electrónico: datos.legal@atzco.com.mx.<br>
    <strong>8.- Medios para revocar el consentimiento</strong><br> EL TITULAR de los datos personales podrá revocar el consentimiento que se otorga con la aceptación del presente. Dicha revocación del consentimiento se deberá de hacer observando el siguiente procedimiento que GRUPO ATZCO pone a su disposición: <br> <strong>8.1.-</strong> Enviar un correo electrónico en atención al Designado en el punto 7-siete del presente Aviso, mediante el cual serán atendidas dichas solicitudes.<br> <strong>8.2.-</strong> Enviar una solicitud o mensaje de datos al correo electrónico antes precisado, en el que señale: <br> <strong>8.2.1.-</strong> El nombre completo de EL TITULAR, domicilio y correo electrónico para recibir la respuesta que se genere con motivo de su solicitud;<br> <strong>8.2.2.-</strong> El motivo de su solicitud;<br> <strong>8.2.3.-</strong> Los argumentos que sustenten su solicitud o petición;<br> <strong>8.2.4.-</strong> Documento oficial que acredite su identidad y que demuestre que es quien dice ser;<br> <strong>8.2.5.-</strong> Fecha a partir de la cual, se hace efectiva la revocación de su consentimiento.<br>
    <strong>8.3.-</strong> GRUPO ATZCO notificará a EL TITULAR, en un plazo máximo de 20-veinte días, contados desde la fecha en que se recibió la solicitud sobre la revocación del consentimiento, la resolución adoptada, a efecto de que, si resulta procedente, se haga efectiva la misma dentro de los 15-quince días siguientes a la fecha en que se comunica la respuesta, mediante un mensaje que contenga que ha ejecutado de todos los actos tendientes a no tratar los datos personales de EL TITULAR.<br>
    <strong>9.- Medios para ejercer los derechos ARCO</strong><br> <strong>9.1.-</strong> En caso de que EL TITULAR necesite Acceder, Rectificar, Cancelar u Oponerse a los datos personales que ha proporcionado a GRUPO ATZCO, EL TITULAR deberá seguir el siguiente procedimiento que GRUPO ATZCO pone a su disposición: <br> <strong>9.2.-</strong> Enviar un correo electrónico en atención al Designado del punto 7-siete del presente Aviso, mediante el cual serán atendidas dichas solicitudes, señalando lo siguiente:<br> <strong>9.2.1.-</strong> El nombre completo de EL TITULAR, domicilio y correo electrónico para recibir la respuesta que se genere con motivo de su solicitud;<br> <strong>9.2.2.-</strong> El motivo de su solicitud;<br> <strong>9.2.3.-</strong> Los argumentos que sustenten su solicitud o petición;<br> <strong>9.2.4.-</strong> Documento oficial que acredite su identidad y que demuestre que es quien dice ser;<br> <strong>9.2.5.-</strong> Descripción clara y precisa de los datos personales respecto de los que se busca ejercer alguno de los derechos ARCO, y cualquier otro elemento o documento que facilite la localización de los datos personales.<br> <strong>9.2.6.-</strong> Tratándose de solicitudes de rectificación de datos personales, EL TITULAR deberá indicar, además de lo señalado, las modificaciones a realizarse y aportar la documentación que sustente su petición.<br> <strong>9.3.-</strong> GRUPO ATZCO notificará a EL TITULAR, en un plazo máximo de 20-veinte días contados desde la fecha en que se recibió la solicitud de acceso, rectificación, cancelación u oposición, la resolución adoptada, a efecto de que, si resulta procedente, se haga efectiva la misma dentro de los 15-quince días siguientes a la fecha en que se comunica la respuesta. Tratándose de solicitudes de acceso a datos personales, procederá la entrega previa acreditación de la identidad del solicitante o representante legal, según corresponda.<br>
    <strong>10.- Transferencia de datos personales</strong><br> <strong>10.1.-</strong> GRUPO ATZCO se obliga a no transferir o compartir los datos a que se refiere el presente Aviso, a favor de terceros, salvo en los casos en que resulte necesario para cumplir con las finalidades del presente Aviso, o bien, sean necesarios en cumplimiento de un requerimiento de autoridad.<br> <strong>10.2.-</strong> Asimismo, en cumplimiento de sus obligaciones legales, y con efectos informativos a EL TITULAR, se le indica que GRUPO ATZCO podrá realizar las siguientes transferencias:<br> <strong>10.2.1.-</strong> IMSS, INFONAVIT y SAT, a efecto de dar cumplimiento a la legislación laboral, de seguridad social, así como el pago de impuestos.<br> <strong>10.2.2.-</strong> Instituciones bancarias, a efecto de realizar el cobro de los productos y/o servicios comercializados por GRUPO ATZCO así como el pago de los productos y/o servicios adquiridos por GRUPO ATZCO.<br>
    <strong>11.- Modificaciones</strong><br> <strong>11.1.-</strong> Las partes acuerdan que el Aviso de Privacidad, puede ser modificado en el tiempo y forma que GRUPO ATZCO lo determine, atendiendo al estudio y las regulaciones que en materia de protección de datos personales surjan, por lo que se obliga a mantener actualizado el presente aviso a efecto de que, en su caso, EL TITULAR se encuentre en posibilidad de ejercer sus derechos ARCO.<br>
    <strong>12.- Autoridad garante</strong><br> <strong>12.1.-</strong> Si EL TITULAR considera que su derecho a la protección de sus datos personales ha sido lesionado por alguna conducta u omisión por parte de GRUPO ATZCO o presume alguna violación a las disposiciones previstas en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, su Reglamento y demás ordenamientos aplicables, podrá interponer su inconformidad o denuncia ante el Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI). Para mayor información, le sugerimos visitar su página oficial de Internet www.inai.org.mx.<br>
    <strong>13.- Ley aplicable y jurisdicción</strong><br><br> <strong>13.1.-</strong> Las partes expresan que el presente aviso, se regirá por las disposiciones legales aplicables en la República Mexicana, en especial, por lo dispuesto en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, su Reglamento y la demás normativa vinculada aplicable.<br> <strong>13.2.-</strong> Para el caso de que exista una disputa o controversia, derivada de la interpretación, ejecución o cumplimiento del aviso o de cualquiera de los documentos que del mismo se deriven, o que guarden relación con éste, las partes amigablemente, buscarán llegar a un acuerdo dentro de un plazo de 30-treinta días naturales, contados a partir de la fecha en que surja cualquier diferencia y se notifique por escrito sobre dicho evento a la contraparte, deduciendo el proceso de mediación ante el Instituto Nacional de Transparencia, Acceso a la información y Protección de Datos Personales (INAI).<br> <strong>13.3.-</strong> En caso de que las partes no lleguen a un acuerdo, convienen en este acto en someter todas las desavenencias que deriven del presente Aviso de Privacidad o de cualquiera de los documentos que del mismo se deriven, o que guarden relación con éste o con aquéllos, a ser resueltas de manera definitiva, sometiéndose a la competencia y leyes de las Autoridades Administrativas Federales o Tribunales del Estado de Guanajuato, renunciando expresamente a cualquier fuero distinto que por razones de sus domicilios presentes o futuros pudieren corresponderles.</p>
<p class="derecha">Fecha última de actualización: 22 de junio del 2022</p>
<br><br><br>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    <p class="derecha">FECHA: <?php echo $diaIngreso; ?> de <?php echo $mesIngreso; ?> de <?php echo $anioIngreso; ?></p>
    ...
    <div class="signature-block">
        <br><br>
        <p class="centrado"><?php echo $nombreCompleto; ?></p>
    ...
    <p><strong>Nombre completo del colaborador:</strong><br><br> <?php echo $nombreCompleto; ?></p>
    <div>
