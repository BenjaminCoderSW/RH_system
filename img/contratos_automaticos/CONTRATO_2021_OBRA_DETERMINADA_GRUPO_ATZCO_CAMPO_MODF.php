...
<body>
    ...
    <div class="content">
        ...
        <p><strong>SEXTA.-</strong> <strong>Beneficiario</strong> "EL TRABAJADOR (A)" en este acto acorde a su consentimiento expreso y
        ...
        <p><strong>OCTAVA.-</strong> "EL TRABAJADOR (A)" conviene en que dedicará al desempeño de sus labores el tiempo
            ...
            TRABAJADOR" no podrá laborar jornada extraordinaria, sin el previo consentimiento <i><strong>expreso y por escrito</strong></i> de
            "LA EMPRESA".</p>
        <br>
        ...
        <p><strong>lll.</strong> Si "EL TRABAJADOR (A)" incurre en faltas graves a los principios y políticas
            empresariales de "LA EMPRESA", establecidas en el presente Contrato, y</p>
            ...
            <tr>
                <td>
                    <div class="signature-block">
                        ...
                        <p><strong>ING. CU GUERRERO JOSÉ DOLORES</strong></p>
    ...
    <p>RECIBÍ DEL ING. JOSE DOLORES CU GUERRERO, EN SU CARÁCTER DE REPRESENTANTE LEGAL DE <strong>"GRUPO ATZCO", S.A. DE C.V.”</strong>, QUIEN ES MI ÚNICO PATRON, LA CANTIDAD DE $</p>
...
<br><br><br>
    ...
    <p>Recibí el <strong>reglamento interior de trabajo</strong> de la empresa <strong>GRUPO ATZCO S.A de C.V</strong></p>
