...
<body>
    ...
    <div class="content">
        <div class="justificado">
            ...
            <p>a)	Ser una sociedad mercantil debidamente constituida conforme a las leyes mexicanas, y estar debidamente inscrita ante el Registro Público de la Propiedad y del Comercio de la ciudad de Salamanca, estado de Guanajuato.</p>
            <p>b)	Tener su domicilio en Boulevard Paseo De Los Insurgentes #902 Int. 7 Colonia Jardines Del Moral León, Gto.</p>
            <p><strong>II.- DECLARA “EL TRABAJADOR ( A )”:</strong></p>
            <p>a)	Llamarse como ha quedado escrito en el encabezado de este contrato.</p>
            <p>b)	Ser de nacionalidad Mexicana.</p>
            <p>c)	Ser de sexo <?php echo $sexo; ?>.</p>
            <p>d)	Ser su estado civil <?php echo $estadoCivil; ?>.</p>
            <p>e)	Mayor de edad.</p>
            <p>f)	Tener su domicilio en <strong><?php echo $domicilio; ?></strong>, y que es que señala para recibir notificaciones por parte de “LA EMPRESA”.</p>
            ...
            <p><strong>SÉPTIMA.- </strong>"EL TRABAJADOR ( A )" conviene en que dedicará al desempeño de sus labores el tiempo de manera efectiva de la duración de su jornada de trabajo a efecto de que no haya atraso ni retraso algunos</p>
            <p class="pieDePagina" >2</p>
            <p>en el trabajo contratado durante la vigencia del presente contrato. Asimismo, las partes convienen que "EL TRABAJADOR" no podrá laborar jornada extraordinaria, sin el previo consentimiento expreso y por escrito de "LA EMPRESA".</p>
            ...
            <p>Las partes, conscientes del contenido, obligaciones, alcance y fuerza legal del presente contrato por tiempo determinado, lo firman y ratifican por duplicado ante testigos, en la ciudad de SALAMANCA,GTO, Estado de GUANAJUATO, el dia <?php echo $diaDeIngreso . " de " . $mesDeIngreso . " de " . $anioDeIngreso; ?> </p>
            <div class="negritas">
            ...
            <p>CONSTRUCTORA ATZCO", S.A. DE C.V. <br>PRESENTE,</p>
            <p></p>
            <br><br><br><br>
            <br><br><p class="pieDePagina">5</p><br>
            ...
            <p>RECIBÍ DEL LIC. GILBERTO GARCIA VELA, EN SU CARÁCTER DE REPRESENTANTE LEGAL DE <strong>“CONSTRUCTORA ATZCO”, S.A. DE C.V.</strong>, QUIEN ES MI ÚNICO PATRON. <br>LA CANTIDAD DE $ <br><br><strong>PARA LOS SIGUIENTES CONCEPTOS:</strong></p>
            <div class="negritas" >
                ...
                <p class="pieDePagina" >6</p>
            <div class="negritas">
                <pre>9.	Gratificación:                                       $</pre><br>
            ...
            <p>c)	Su representante legal, Israel Rodríguez Escamilla, cuenta con las facultades suficientes para celebrar el presente Convenio y obligar a su representada en términos del mismo y que dichas facultades no le han</p>
            <p class="pieDePagina" >7</p>
            <p>sido modificadas, limitadas o restringidas en forma alguna a la fecha del presente Convenio, como se desprende de la escritura pública número 29,286, de fecha 29 de Agosto del 2012, otorgada ante la fe del Lic. Alejandro Duran Llamas, Notario Público número 44 de la ciudad de León, Gto.</p>
            ...
            <p><strong>SEGUNDA.- </strong>EL CONFIDENTE se obliga a guardar en pleno secreto y confidencia la totalidad de la documentación e información a la que tiene acceso como consecuencia directa o indirecta de su relación laboral con LA EMPRESA y con los clientes de la misma, la cual se encuentra descrita en forma enunciativa, más no limitativa, en el Anexo A del presente Convenio (la “Información Confidencial”).</p>
            ...
            <p><strong>QUINTA.- </strong>Si EL CONFIDENTE fuera requerido por autoridad competente de cualquier tipo para revelar información delicada, relevante o Información Confidencial de LA EMPRESA y/o de clientes de la misma,</p>
            <p class="pieDePagina" >9</p>
            <p>se obliga a dar aviso por escrito a LA EMPRESA y/o al cliente de que se trate, dentro de los 3 (tres) días hábiles siguientes a la recepción del documento respectivo, con la finalidad de que la parte que corresponda pueda ejercitar los actos o derechos que correspondan para salvaguardar sus intereses.</p>
            ...
            <p><strong>DÉCIMA CUARTA.- </strong>Para la interpretación y cumplimiento de este Convenio las Partes aceptan sujetarse a la jurisdicción y leyes de los Tribunales competentes de la ciudad de León, Guanajuato, renunciando expresamente a cualquier otro fuero que por razón de sus domicilios presentes o futuros, o por cualquier 
            <p class="pieDePagina" >10</p>
            <p></p>otra razón, pudiera corresponderles.</p><br>
            ...
            <p>ESTE ANEXO FORMA PARTE INTEGRANTE DEL CONVENIO DE CONFIDENCIALIDAD CELEBRADO ENTRE CONSTRUCTORA ATZCO SA DE CV, REPRESENTADA EN ESTE ACTO POR ISRAEL RODRÍGUEZ ESCAMILLA, EN LO SUCESIVO DENOMINADA LA EMPRESA, Y <?php echo $apellidoPaterno . " " . $apellidoMaterno . " " . $nombres; ?> DE FECHA <?php echo $diaDeIngreso . " DEL MES DE " . $mesDeIngreso . " DE " . $anioDeIngreso; ?></p>
            ...
            <br><br><br><p class="pieDePagina" >11</p><br><br><br><br>
            <ul>
            ...
            <br><br><br>
            <p class="pieDePagina" >12</p><br>
            <p class="centrado">SALAMANCA,GTO, GUANAJUATO. A <?php echo $diaDeIngreso . " de " . $mesDeIngreso . " de " . $anioDeIngreso; ?></p>
            <div class="negritas">
                <br><pre>             "LA EMPRESA"                           "EL CONFIDENTE"            </pre>
                <br><br><br>
                <pre>___________________________________       ______________________________________</pre>
            ...
            <div class="margen-solo-izquierdo">
                <p>Por medio de la presente el que suscribe <?php echo $apellidoPaterno . " " . $apellidoMaterno . " " . $nombres; ?> le externo mi consentimiento y aceptación de manera libre y espontánea, para que se me entreviste y se realice el llenado de mi declaración de estado de salud para cuestiones informativas.</p>
                <p>Por lo expuesto, no tengo inconveniente alguno en que la Empresa Constructora Atzco S.A de C.V me pida que realice el llenado de mi declaratoria de estado de salud, agradeciendo de antemano la atención y facilidades que le puedan brindar para agilizar los trámites que le interesen.</p>
                <p>Finalmente</p>
                <p>En el Estado y Ciudad de, SALAMANCA,GUANAJUATO, a <?php echo $diaDeIngreso . " de " . $mesDeIngreso . " de " . $anioDeIngreso; ?>.</p>
                <br><br>
                ...
                <p class="pieDePagina" >13</p><br><br>
            </div>
            <br>
            ...
            <div class="centrado negritas"><br><br><br><br><br><br><br>
                <p>____________________________________________</p>
                <p><?php echo $apellidoPaterno . " " . $apellidoMaterno . " " . $nombres; ?></p>
                <p>Nombre, Firma y Huella</p>
            </div>
            <br><p class="pieDePagina" >16</p><br>
            <div class="justificado">
                <P class="sub-tituloCentrado rojo-blanco negritas">ACUSE DE RECIBO</P>
                <p>Recibí el reglamento interior de trabajo de la empresa Constructora Atzco S.A de C.V<br>
