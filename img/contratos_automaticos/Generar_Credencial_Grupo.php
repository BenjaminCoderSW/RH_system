...
$rutaLogoGrupoAtzco = "C:/laragon/www/HR_System/img/Grupo_Atzco_Credencial_Logo.jpeg";
...
//$rutaLogoGrupoAtzco = "/home/u496700722/domains/atzcorh.net/public_html/HR_System/img/Grupo_Atzco_Credencial_Logo.jpeg";
...
if (file_exists($rutaLogoGrupoAtzco)) {
    $tipoMimeLogoGrupoAtzco = mime_content_type($rutaLogoGrupoAtzco);
    $dataLogoAtzco = base64_encode(file_get_contents($rutaLogoGrupoAtzco));
    $rutaLogoAtzcoBase64 = 'data:' . $tipoMimeLogoGrupoAtzco . ';base64,' . $dataLogoAtzco;
} else {
    $rutaLogoAtzcoBase64 = ''; // Aquí puedes poner una imagen de respaldo en caso de que el logo no exista
}
...
<body>
    ...
    <div class="credencial">
        <div class="header">
            <?php if ($rutaLogoAtzcoBase64): ?>
                <img src="<?php echo $rutaLogoAtzcoBase64; ?>" alt="Logo de la empresa">
            <?php endif; ?>
            Grupo Atzco, S.A. de C.V.
        </div>
        <div class="foto-area">
