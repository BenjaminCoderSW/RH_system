<?php
    ...
    // para eso divido la cantidad de datos ($total) entre el numero maximo de registros permitidos en cada pagina ($registros) 
		...
		foreach($datos as $rows){
			...
			$tabla.='
				<tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="'.$url.$pagina.'&user_id_del='.$rows['usuario_id'].'" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                </tr>
            ';
            $contador++;
