            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_nombre_completo_Update" name="empleado_nombre_completo" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" required value="<?php echo $datos['empleado_nombre_completo']; ?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="Empleado_Fecha_de_Ingreso_Update" name="empleado_fecha_de_ingreso" required value="<?php echo $datos['empleado_fecha_de_ingreso']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step=".01" class="form-control" id="Empleado_Salario_Diario_Integrado_Update" name="empleado_salario_diario_integrado" required value="<?php echo $datos['empleado_salario_diario_integrado']; ?>">
                    </div>
                    <div class="form-group">
