            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_nombre_completo_Update" name="empleado_nombres" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,100}" maxlength="100" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 100" required value="<?php echo $datos['empleado_nombres']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ]{3,50}" maxlength="50" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 50" required value="<?php echo $datos['empleado_apellido_paterno']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ]{3,50}" maxlength="50" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 50" required value="<?php echo $datos['empleado_apellido_materno']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_lugar_de_nacimiento_Update" name="empleado_lugar_de_nacimiento" maxlength="255" data-toggle="tooltip" title="Máximo 255 caracteres" required value="<?php echo $datos['empleado_lugar_de_nacimiento']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_domicilio_Update" name="empleado_domicilio" maxlength="255" data-toggle="tooltip" title="Máximo 255 caracteres" required value="<?php echo $datos['empleado_domicilio']; ?>">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_Telefono_Update" name="empleado_telefono" pattern="[\+]?[0-9]{1,4}[-\s]?([0-9]{3,4}[-\s]?)*[0-9]{3,4}" maxlength="15" data-toggle="tooltip" title="Formato: 7732456777" required value="<?php echo $datos['empleado_telefono']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Nombre_de_Contacto_para_emergencia_Update">Nombre del Contacto de Emergencia:</label>
                        <input type="text" class="form-control" id="Empleado_Nombre_de_Contacto_para_emergencia_Update" name="empleado_nombre_de_contacto_para_emergencia" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 255" required value="<?php echo $datos['empleado_nombre_de_contacto_para_emergencia']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Parentezco_con_el_Contacto_de_emergencia_Update">Parentezco:</label>
                        <input type="text" class="form-control" id="Empleado_Parentezco_con_el_Contacto_de_emergencia_Update" name="empleado_parentezco_con_el_contacto_de_emergencia" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,50}" maxlength="50" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 50" required value="<?php echo $datos['empleado_parentezco_con_el_contacto_de_emergencia']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Telefono_de_Contacto_para_Emergencia_Update">Teléfono de Emergencia:</label>
                        <input type="text" class="form-control" id="Empleado_Telefono_de_Contacto_para_Emergencia_Update" name="empleado_telefono_de_contacto_para_emergencia" pattern="[\+]?[0-9]{1,4}[-\s]?([0-9]{3,4}[-\s]?)*[0-9]{3,4}" maxlength="15" data-toggle="tooltip" title="Formato: 5578652345" required value="<?php echo $datos['empleado_telefono_de_contacto_para_emergencia']; ?>">
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_Puesto_de_Trabajo_Update" name="empleado_puesto_de_trabajo" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,100}" maxlength="100" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 100" required value="<?php echo $datos['empleado_puesto_de_trabajo']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        pattern="^\d+$" maxlength="2" data-toggle="tooltip" title="Formato: DD (01-31)" required value="<?php echo $datos['empleado_dia_de_ingreso']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_mes_de_ingreso_Update">Mes de Ingreso:</label>
                        <select class="form-control" id="Empleado_mes_de_ingreso_Update" name="empleado_mes_de_ingreso" data-toggle="tooltip" title="Selecciona el mes de ingreso">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_Lugar_de_Servicio_o_de_Proyecto_Update" name="empleado_lugar_de_servicio_o_de_proyecto" maxlength="255" data-toggle="tooltip" title="Máximo 255 caracteres" required value="<?php echo $datos['empleado_lugar_de_servicio_o_de_proyecto']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        pattern="^-?\d{1,8}(\.\d{2})?$" maxlength="11" data-toggle="tooltip" title="Formato: 1234.56" required value="<?php echo $datos['empleado_salario_diario_integrado']; ?>">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Empleado_Curp_Update" name="empleado_curp" pattern="^([A-Z]{4}[0-9]{6}[HM]{1}[A-Z]{5}[0-9A-Z]{2})$" maxlength="18" data-toggle="tooltip" title="Formato: 18 caracteres, ejemplo: ABCD123456HDFGRT12" required value="<?php echo $datos['empleado_curp']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Rfc">RFC:</label>
                        <input type="text" class="form-control" id="Empleado_Rfc_Update" name="empleado_rfc" pattern="^([A-ZÑ&]{3,4}[0-9]{6}[A-Z0-9]{3})$" maxlength="13" data-toggle="tooltip" title="Formato: 13 caracteres, ejemplo: ABCD123456ABC" required value="<?php echo $datos['empleado_rfc']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Nss">Número de Seguro Social:</label>
                        <input type="text" class="form-control" id="Empleado_Nss_Update" name="empleado_nss" pattern="\d{2} \d{2} \d{2} \d{2} \d{2} \d{1}" maxlength="16" data-toggle="tooltip" title="Formato: 11 dígitos con espacios, ejemplo: 22 22 22 22 22 2" required value="<?php echo $datos['empleado_nss']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Tipo_de_sangre">Tipo de Sangre:</label>
                        <input type="text" class="form-control" id="Empleado_Tipo_de_sangre_Update" name="empleado_tipo_de_sangre" pattern="[a-zA-Z+\-]+" maxlength="3" data-toggle="tooltip" title="Formato: letras y signos (+, -), máximo 3 caracteres" required value="<?php echo $datos['empleado_tipo_de_sangre']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Alergias">Alergias:</label>
                        <input type="text" class="form-control" id="Empleado_Alergias_Update" name="empleado_alergias" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 255" required value="<?php echo $datos['empleado_alergias']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Enfermedades">Enfermedades:</label>
                        <input type="text" class="form-control" id="Empleado_Enfermedades_Update" name="empleado_enfermedades" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 255" required value="<?php echo $datos['empleado_enfermedades']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Nombre_Completo_de_la_Madre">Nombre Completo de la Madre:</label>
                        <input type="text" class="form-control" id="Empleado_Nombre_Completo_de_la_Madre_Update" name="empleado_nombre_completo_de_la_madre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 255" required value="<?php echo $datos['empleado_nombre_completo_de_la_madre']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="Empleado_Nombre_Completo_del_Padre">Nombre Completo del Padre:</label>
                        <input type="text" class="form-control" id="Empleado_Nombre_Completo_del_Padre_Update" name="empleado_nombre_completo_del_padre" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,255}" maxlength="255" data-toggle="tooltip" title="Solo letras Aa-Zz, mínimo 3 caracteres, máximo 255" required value="<?php echo $datos['empleado_nombre_completo_del_padre']; ?>">
                    </div>
